...
async def test_chaos_ai_analyzer_outage(client, mocker):
    ...
    mocker.patch("workers.ai_circuit_breaker.llm_breaker.is_available", return_value=False)
    ...
    print("Chaos Test Passed: System survived AI outage and degraded to Algorithmic mode seamlessly.")
